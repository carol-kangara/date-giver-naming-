...
function birthDay(){
   ...
   var CC = math.trunc(parseInt((year/100)));
...
if(birthDay==0 && gender==female){
    ...
    alert("You were born on Teusday and Your akan name is Abenaa");
}
...
if(birthDay==0 && gender==male){
    ...
    alert("You were born on Teusday and Your akan name is kwabena");
}
